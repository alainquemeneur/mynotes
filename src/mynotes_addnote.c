...
if(success==1)
	...
	printf("<div data-role=\"navbar\">\n\
      ...
      <form autocomplete=\"off\" action=\"/cgi-bin/mynotes_doaddnote.cgi\" method=\"post\" id=\"form\" data-transition=\"none\" data-rel=\"dialog\">\n\
      		<input type=\"hidden\" name=\"txt-compte\" id=\"txt-compte\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
   ...
   printf("</select>\n\
            ...
            <div data-role=\"fieldcontain\">\n\
               ...
               <input type=\"text\" name=\"txt-titre\" id=\"txt-titre\" value=\"\" maxlength=\"200\" required=\"required\">\n\
            </div>\n\
            <div data-role=\"fieldcontain\">\n\
               <label for=\"txt-note\">Note</label>\n\
               <textarea name=\"txt-note\" id=\"txt-note\" value=\"\" maxlength=\"20000\" required=\"required\"></textarea>\n\
            </div>\n\
