...
if(success==1)
	...
	if(db_ntuples(result)>0)
		{
		printf("<form autocomplete=\"off\" action=\"/cgi-bin/mynotes_modifdossier2.cgi\" method=\"post\" id=\"form-dosuppr\" data-transition=\"none\" data-rel=\"dialog\">\n\
		...
		printf("</fieldset>\n<input type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"c\" data-icon=\"edit\" value=\"Modifier ce dossier\">\n</form>\n");
		}
	db_clear_result(result);
	db_close(handler);
   printf("</div>\n\
