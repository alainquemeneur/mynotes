...
if(success==0) printf("%s\n\
      <a href=\"/mynotes/index.html\" class=\"ui-btn ui-btn-c ui-corner-all mc-top-margin-1-5\">Ressayez</a>",reponse);
if(success==1) printf("Votre compte n'est pas protégé par un deuxième facteur d'authentification, ce qui améliorerait pourtant sa sécurité. Vous pouvez activer cette fonctionnalité depuis la page de votre profil<br>\n\
						<form action=\"/cgi-bin/mynotes_main.cgi\" method=\"post\" id=\"form-connect\" data-transition=\"none\" data-rel=\"dialog\">\n\
                  ...
                  <button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"c\" data-icon=\"action\" class=\"ui-shadow\">Accéder à vos dossiers</button>\n\
                  </form>\n",nom,mdp);
if(success==2) 
	{
	printf("<form autocomplete=\"off\" action=\"/cgi-bin/mynotes_main.cgi\" method=\"post\" id=\"form\" data-transition=\"none\" data-rel=\"dialog\">\n\
            <input type=\"hidden\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\">\n\
            <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
            ...
            <button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"c\" data-icon=\"action\">Accéder à vos dossiers</button>\n\
         </form>\n",nom,mdp);
	sprintf(reponse,"rm /var/www/html/mynotes/qr/qr%s.png",nom);
	system(reponse);
	}
printf("</div>\n\
