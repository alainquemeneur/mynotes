...
char *envoi;
int i,start,success;
char *query,*reponse,*lienretour,*textebouton,*totpsecret,*totpcode,*nomdossier;
...
if(success==1)
	...
	printf("<div data-role=\"navbar\">\n\
      ...
      <form autocomplete=\"off\" action=\"/cgi-bin/mynotes_domodifdossier.cgi\" method=\"post\" id=\"form\" data-transition=\"none\" data-rel=\"dialog\">\n\
      		<input type=\"hidden\" name=\"txt-compte\" id=\"txt-compte\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
                  <input type=\"hidden\" name=\"txt-dossier\" id=\"txt-dossier\" value=\"%s\">\n\
            <div data-role=\"fieldcontain\">\n\
               <label for=\"txt-site\">Nom du dossier</label>\n\
               <input type=\"text\" name=\"txt-nom\" id=\"txt-nom\" value=\"%s\" maxlength=\"200\" required=\"required\">\n\
            </div>\n\
...
</html>\n",nom,mdp,code,nom,mdp,code,nomdossier,nomdossier);
	}
else
	{
	printf("</div>\n\
